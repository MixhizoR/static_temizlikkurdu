  ...
  connectedCallback() {
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-3 py-2">
      <a class="navbar-brand d-flex align-items-center" href="index.html">
        ...
        <span class="ms-2" style="font-size: 1.2rem; font-weight: 700; color: #ffc107;">Detay Temizlik</span>
      </a>
      ...
      <div class="social-icons d-flex align-items-center ms-auto">
        <a href="https://www.instagram.com/detaytemizlik38" target="_blank" class="mx-2 text-warning"><i class="fab fa-instagram"></i></a>
        <a href="mailto:detaytemizlikkayseri@gmail.com" class="mx-2 text-warning"><i class="fas fa-envelope"></i></a>
        <a href="tel:+905411739698" class="mx-2 text-warning"><i class="fas fa-phone-alt"></i></a>
      </div>
    </nav>
    `;
  }
        ...
        <div class="row">
          <div class="col-md-4 mb-4">
            <a href="#" class="d-flex align-items-center mb-3 text-decoration-none">
              ...
              <span class="fs-5 fw-bold text-warning">Detay Temizlik</span>
            </a>
          ...
          <div class="col-md-5 mb-4">
            ...
            <p class="small mb-1"><i class="fas fa-phone-alt me-2 text-warning"></i><a href="tel:+905411739698" style="color:inherit; text-decoration:none;">+90 541 173 96 98</a></p>
            <p class="small"><i class="fas fa-envelope me-2 text-warning"></i><a href="mailto:detaytemizlikkayseri@gmail.com" style="color:inherit; text-decoration:none;">detaytemizlikkayseri@gmail.com</a></p>
          </div>
        </div>
        <hr class="border-warning my-3" />
        <div class="text-center pb-2">
          <small class="text-white-50">Copyright © 2026 Detay Temizlik. Tüm Hakları Saklıdır.</small>
        </div>
      </div>
    </footer>
    `;
...
class WhatsAppButton extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
      <a href="https://wa.me/905411739698" target="_blank" aria-label="WhatsApp"
